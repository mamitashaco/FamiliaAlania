...
function GraficoResumenFinanzas({ registros }: { registros: Registro[] }) {
  ...
  useEffect(() => {
    ...
    ctx.strokeStyle = "#94a3b8"; ctx.beginPath(); ctx.moveTo(izquierda, 180); ctx.lineTo(w - derecha, 180); ctx.stroke();
